              ...
              <div className="px-4 lg:px-6">
                ...
                <div className="flex items-center justify-between gap-2 mb-4">
                  <h2 className="text-lg font-semibold">
                    <Skeleton className="h-6 w-36 inline-block" />
                  </h2>
                    ...
                    <table className="w-full table-fixed caption-bottom text-sm">
                      <thead className="[&_tr]:border-b bg-muted border-b shadow-sm sticky top-0 z-10">
                        <tr>
                          ...
                          {/* Páginas (cluster_size) - FALTAVA! */}
                          <th className="h-10 text-center w-[10%] px-4">
                          ...
                          {/* CTR */}
                          <th className="h-10 text-right w-[10%] px-4">
